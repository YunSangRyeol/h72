				...
				<div
					...
					<table border="1" summary="">
						...
						<tr>
								<tr align="left">
									<th>제목</th>
									<td><input type="text" name="upNoticeTitle" id="upNoticeTitle" style="width:100%;" ></td>
									</tr>
						<tr align="left">
							<td>&nbsp; 내용</td>
							<td><textarea cols="100" rows="7" name="upNoticeContent" id="upNoticeContent"  style="width:100%;">${list.noticeContent }</textarea></td>
						</tr>
